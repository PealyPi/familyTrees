...
function nodeDataStorage(){//collapse lvl 2
	...
	kesby.jeanBobby = {			
		...
		kesby.sidneyCharlesBobby = {	
			...
			'mainLine':		true,		
			'familyName': 'bobby',
			'parentL': 		'benjaminBobby',
			'parentR': 		'fannyClarkChapman',	
		...
		kesby.jamesHerbertBobby = {	
			...
			kesby.benjaminBobby = {	
				...
				'mainLine':		true,		
				'familyName': 'bobby',
				'parentL': 		'charlotteAtkins',
				'parentR': 		'william5Bobby',	
			...
			kesby.williamBobby = {			
				...
				kesby.william5Bobby = {	
					...
					'mainLine':		true,		
					'familyName': 'bobby',
					'parentL': 		'benjamin6Bobby',
					'parentR': 		'sarahHubbard',	
				...
				kesby.estherBobby = {		
					...
					kesby.susanBobby = {	
						...
						kesby.jamesBobby = {	
							...
							'mainLine':		true,		
							'familyName': 'bobby',
							'parentL': 		'benjamin8Bobby',
							'parentR': 		'ursulaPitman',	
