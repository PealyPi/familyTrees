		...
		kesby.jamesHerbertBobby = {	
			...
			kesby.williamBobby = {			
				...
				kesby.charlotteAtkins = {
					...
					'children':		['benjaminBobby', 'nathonBobby', 'annBobby', 'carolineBobby', 'harrieBobby', 'walterBobby', 'williamBobby']
				};
				kesby.william5Bobby = {	
					'gen': 5,
					'mainLine':		true,	
				...
				kesby.estherBobby = {		
					...
					kesby.benjamin6Bobby = {	
						...
						'children':		['william5Bobby', 'carolineBobby', 'suzannahBobby', 'sarahBobby', 'benjamin5Bobby', 'estherBobby']
					};
					kesby.sarahHubbard = {	
						'gen': 6,
						'mainLine':		true,	
					...
					kesby.susanBobby = {	
						...
						kesby.jamesBobby = {	
							...
							'children':		['benjamin6Bobby', 'susanBobby']
						};
						kesby.suzannaBobby = {	
							'gen': 7,
							'mainLine':		true,	
